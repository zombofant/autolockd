...
screen_saver_query_extension.argtypes = [POINTER(Display), POINTER(c_int), POINTER(c_int)]
...
screen_saver_query_info.argtypes = [POINTER(Display), Drawable, POINTER(ScreenSaverInfo)]
